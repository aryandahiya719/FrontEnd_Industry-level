...
import { Mail, Lock, User, ArrowLeft, Heart, Sparkles } from 'lucide-react';
...
const CustomerLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-50 px-6 py-12 relative overflow-hidden">
      ...
      {/* Background Hero Abstract (Warmth) */}
      ...
      >
        ...
        <div className="space-y-6 mb-12">
          ...
          <h2 className="text-5xl heading-display uppercase tracking-tight text-[color:var(--color-secondary)]">Join the Feast</h2>
          <p className="font-bold text-slate-400 text-sm max-w-sm mx-auto">Access your flavors, track your favorites, and experience Cremy Gastronomy.</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-8 text-left">
          <div className="space-y-3">
             <label className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-300 ml-5">Registered Email</label>
          ...
          >
            <Sparkles className="w-6 h-6" /> Begin Gastronomy
          </motion.button>
        </form>

        <div className="mt-16 pt-8 border-t border-slate-50">
           <p className="text-xs font-bold text-slate-300 uppercase tracking-widest">
              Don't have an account? <span className="text-orange-500 cursor-pointer hover:underline">Register your palate</span>
           </p>
        </div>
      </motion.div>
    </div>
